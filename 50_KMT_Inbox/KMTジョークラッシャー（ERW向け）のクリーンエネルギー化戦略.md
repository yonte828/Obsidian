# [[KMTMOC|KMT]][[ジョークラッシャー]]（[[ERW]]向け）の[[重機のクリーンエネルギー化に向けた検討事項|クリーンエネルギー]]化戦略

## 1. 現状と課題

[[KMTMOC|KMT]]の[[ジョークラッシャー]]は、[[岩石風化促進法]]（[[ERW]]）において、玄武岩などのケイ酸塩鉱物を細かく粉砕する重要な役割を担う。[[ERW]]は[[CO2]]を固定化するクリーンな技術である一方、岩石の粉砕プロセス自体は大量のエネルギーを消費し、現状では[[ディーゼルエンジン]]駆動が主流であるため、[[CO2]]排出を伴う。[[ERW]]の真の[[カーボンニュートラル燃料の種類|カーボンニュートラル]]実現には、[[ジョークラッシャー]]自体の[[重機のクリーンエネルギー化に向けた検討事項|クリーンエネルギー]]化が不可欠である。
...
*   **コストと経済性:** [[重機のクリーンエネルギー化に向けた検討事項|クリーンエネルギー]]化に伴う初期投資と運用コストのバランス、[[ERW]]事業全体の経済性への貢献。
